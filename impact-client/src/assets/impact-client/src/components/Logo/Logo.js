...
/**
 * The Insight logo, that's all!
 */
export default function Logo({ isInverted }) {
  return (
    <div className="c-sidebar__logo">
      <a href="/">
        <svg viewBox="0 0 460 120.1" className={cn('c-logo', { 'is-inverted': isInverted })}>
          <g>
            <g id="Symbol">
              <path fill="#9F177A" d="M60.6,89.7V42.9h11.8v46.7H60.6z M73.6,11c0-4-3.1-7.2-7.1-7.2c-4,0-7.2,3.2-7.2,7.2c0,4,3.2,7.1,7.2,7.1 C70.5,18.1,73.6,15,73.6,11z" />
              ...
              <path fill="#A80B6E" d="M89.7,35.4H42.9V23.6h46.7V35.4z M11,22.3c-4,0-7.2,3.1-7.2,7.1c0,4,3.2,7.2,7.2,7.2c4,0,7.1-3.2,7.1-7.2 C18.1,25.4,15,22.3,11,22.3z" />
