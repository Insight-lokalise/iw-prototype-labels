...
export default function PDPBody({
  ...
  const overviewTab = {
    ...
    id: 'Overview',
    name: t('Overview'),
    className: 'c-cs-mini-pdp__tab u-font-size-small',
  }
  const techSpecsTab = {
...
PDPBody.propTypes = {
  ...
  isViewPriceEnabled: PropTypes.bool.isRequired,
  isViewAvailabilityEnabled: PropTypes.bool.isRequired,
