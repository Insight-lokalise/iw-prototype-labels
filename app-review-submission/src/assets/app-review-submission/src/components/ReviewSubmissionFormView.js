...
import { Field, Form, StarRating, Icon } from '@insight/toolkit-react'
import {
  FieldError,
  Label,
...
export default function ReviewSubmissionFormView(props) {
  ...
  const recommendedOptions = [
    { id: 'recommended', label: t('Yes'), value: 'true' },
    { id: 'notRecommended', label: t('No'), value: 'false' },
  ]
  return (
    <div>
          ...
          >
              ...
              {({ fieldProps, meta }) => (
                <div className="c-form__element">
                  <div className="o-grid  o-grid--gutters">
                    ...
                    <div className="o-grid__item o-grid__item--shrink">
                      <StarRating
                        containerClassName="c-star-rating c-review-submission__star-ratings"
                        editable
                        rating={0}
                        onStarClick={(value) => {
            ...
            <Field name="reviewText" id="reviewText">
              {({ fieldProps, meta }) => (
                <div
                  className={cn('c-form__element c-form__element--bordered', {
                    'has-error': reviewMsg || (meta.touched && meta.error),
                  })}
                >
            ...
            <Field name="userNickName" id="userNickName">
              {({ fieldProps, meta }) => (
                <div
                  className={cn('c-form__element c-form__element--bordered', {
                    'has-error': nickNameMsg || (meta.touched && meta.error),
                  })}
                >
            ...
            <div className="c-submit-review-modal__form-required c-form__element--bordered">
