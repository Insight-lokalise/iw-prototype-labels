...
import { selector_defaultBillingAddress } from '../selectors'
import * as constants from '../constants';
import get from 'lodash-es/get'

export function storedBillingAddresses(state = selector_defaultBillingAddress(InitialState), action) {
    switch (action.type) {
        case `${constants.GET_BILLING_STORED_ADDRESS}_FULFILLED`:
            return {
                ...state,
        ...
        case `${constants.GET_BILLING_STORED_ADDRESS}_PENDING`:
            return {
                ...state,
                isPending: true,
            }
        case `${constants.GET_BILLING_STORED_ADDRESS}_REJECTED`:
            return {
                ...state,
                isPending: false,
                isDialogVisible: false,
            }
        case constants.UPDATE_BILLING_FAVORITE_NAME: {
