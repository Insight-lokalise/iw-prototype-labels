...
export default function PartNumbers({ className, inline, insightPart, mfrPart, unspsc }) {
  ...
  return (
    <table className={classNames}>
      <caption className="c-structured-list__caption u-hide-visually">{t('Part numbers')}</caption>
      <tbody className="c-structured-list__items">
        {insightPart && (
          <tr className="c-structured-list__item">
            <th className="c-structured-list__term c-pdp__details--table-row" scope="row">{t('Insight #:')}</th>
            <td className="c-structured-list__description c-pdp__details--table-row">{insightPart}</td>
          </tr>
        )}
        {mfrPart && (
          <tr className="c-structured-list__item" >
            <th className="c-structured-list__term c-pdp__details--table-row" scope="row">{t('Mfr #:')}</th>
            <td className="c-structured-list__description c-pdp__details--table-row">{mfrPart}</td>
          </tr>
        )}
        {unspsc && (
          <tr className="c-structured-list__item">
            <th className="c-structured-list__term c-pdp__details--table-row" scope="row">{t('UNSPSC #:')}</th>
