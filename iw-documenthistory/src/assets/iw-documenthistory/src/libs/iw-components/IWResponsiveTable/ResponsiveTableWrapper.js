...
import {addOrDropColumnsIfNecessary, findHighestPriority, getVisibleColumns} from './helpers'
...
const ResponsiveTableWrapper = WrappedIWResponsiveTable =>
  class extends Component {
    ...
    onDivResize(dimensions) {
      ...
      if(!isDesktop()) {
        this.setState({ ...stateChanges, maxExpandedPriortiy: 1, visibleTableColumns: getVisibleColumns(this.props.tableColumns)  })
      }
    }
